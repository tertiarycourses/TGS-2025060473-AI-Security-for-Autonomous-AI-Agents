...
def video_slide(title, poster, video_url, kicker=None, accent=BLUE, caption=None,
    ...
    if video_url and not local:
        ...
        txt(s, vx - Inches(0.1), int(vy + vh + Inches(0.12)), int(vw + Inches(0.2)),
            ...
            align=PP_ALIGN.CENTER)
    if caption:
        txt(s, rx, Inches(6.62), rw, Inches(0.28),
...
def activity_slide(a):
    ...
    # meta
    txt(s, Inches(0.85), Inches(6.48), Inches(11.63), Inches(0.34),
...
def lms_slide(spec=None):
    ...
    txt(s, Inches(0.85), Inches(6.70), Inches(11.7), Inches(0.24),
        [[(note, 11, GREY, False)]], align=PP_ALIGN.CENTER)
    footer(s); return s
